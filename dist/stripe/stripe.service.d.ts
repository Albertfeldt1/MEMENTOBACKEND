...
export declare class StripeService {
    ...
    createPrice(planName: string, amount: number, interval: "month" | "year", description?: string, stripeCustomerId?: string, startSubscriptionDate?: string, endSubscriptionDate?: string, subscriptionPlan?: string): Promise<Stripe.Response<Stripe.Price>>;
